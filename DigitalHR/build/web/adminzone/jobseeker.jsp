...
<!--                <div style="overflow-x:auto;white-space: nowrap; margin: 0 auto; ">-->
                <table border="1" style="width: 90%; margin: 0 auto; border-collapse: collapse; text-align: center;">
                    ...
                    <tr style="background-color: black;color: white;">
                        ...
                        <td><a style="color: white;" href="admincode/deletejobseeker.jsp?emailaddress=<%=rs.getString(6)%>">Delete</a></td>
                    </tr>
