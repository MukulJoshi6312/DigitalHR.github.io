...
<html>
    ...
    <body bgcolor="green">
        <div id="outer">
            ...
            <div id="main">
                <h1 style="color: blue;text-align: center;">Manage Notifications</h1>
                <form action="admincode/addnotificationcode.jsp" method="post">
                    <table style="width: 60%; margin: 0 auto;">
                        <tr>
                            ...
                            <td>
                                <textarea name="notificationtext" rows="5" cols="30" style="resize: none;" required></textarea>
                            </td>
                        </tr>
                        <tr>
                            <td>&nbsp;</td>
        ...
        while(rs.next())
        {
                        ...
                        <tr style="background-color: black;color: white;">
                            ...
                            <td><a href="admincode/deletenotification.jsp?id=<%=rs.getString(1)%>">Delete</a></td>
                        </tr>
                        <% } %>
